...
public class PdfRendererBasicFragment extends Fragment implements View.OnClickListener {
    ...
    private static final String TAG = PdfRendererBasicFragment.class.getCanonicalName();
    /**
     ...
     */
    private static final String FILENAME = "pinkas.pdf";
    ...
    private void updateUi() {
        ...
        Log.e(TAG, "updateUi: "+ getString(R.string.app_name_with_index, index + 1, pageCount));
    }
